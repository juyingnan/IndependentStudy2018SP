...
# 数据集地址
image_root_path = 'c:/Users/bunny/Desktop/dataset1/root/'
# 模型保存地址
model_path = image_root_path + 'model.ckpt'
# model_meta_path = image_root_path + 'model.ckpt.meta'
...
for i in range(total_round):
    # read image
    data, label = read_img_random(image_root_path, image_count)
    ...
    for epoch in range(n_epoch):
        ...
        print("Round %i:" % (i * n_epoch + epoch + 1))
